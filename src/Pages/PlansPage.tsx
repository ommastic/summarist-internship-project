...
export default function ChoosePlan({isLoginOpen, setIsLoginOpen}: ChoosePlanProps) {
    ...
    <div>
      ...
      <div className="row main__header" >
        ...
        <div className="button__wrapper">
          ...
          <button className="register__button" onClick={() => setIsLoginOpen(true)}>Start your first month</button>
